...
class AboutMethodBindings(Koan):
    ...
    def test_get_descriptor_resolves_attribute_binding(self):
        ...
        self.assertEqual('AboutMethodBindings', binding_owner.__class__.__name__) # 'about method bindings is the class that wraps the boundclass. 

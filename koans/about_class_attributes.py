...
class AboutClassAttributes(Koan):
    ...
    def test_creating_objects_without_defining_a_class(self):
        ...
        #these are the lengths of the attributes available. More on the class and object than the instance of object()
    ...
    def test_classmethods_are_not_independent_of_instance_methods(self):
        ...
        self.assertRegex(self.Dog2.growl(), "classmethod growl, arg: cls=Dog2"
                         ) #not positive why it ran the decorated version of growl instead of the first one. I suppose because it is a classmethod. I guess the point here is that they both return Dog2 as the class name   
...
#classmethod' object is not callable
    ...
    def test_classes_and_instances_do_not_share_instance_attributes(self):
        ...
        #one sets the class name the other sets the instance name. 
